...
const PART_POOL: { part: string; ops: string[]; qty: [number, number] }[] = [
  ...
  { part: "Cihaz şasesi CS-77", ops: ["op-lazer", "op-abkant", "op-kaynak", "op-kalite"], qty: [20, 80] },
  ...
  { part: "Konveyör sac yatağı", ops: ["op-lazer", "op-abkant", "op-kaynak", "op-paket"], qty: [30, 110] },
  ...
  { part: "Redüktör gövdesi RG-8", ops: ["op-freze", "op-matkap", "op-kalite", "op-paket"], qty: [10, 60] },
  ...
  { part: "Rulman yatağı RY-6205", ops: ["op-torna", "op-freze", "op-matkap", "op-kalite", "op-paket"], qty: [25, 130] },
